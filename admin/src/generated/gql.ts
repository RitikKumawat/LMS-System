...
type Documents = {
    ...
    "mutation CreateCertificateTemplate($createCertificateTemplateInput: CreateCertificateTemplateInput!) {\n  createCertificateTemplate(\n    createCertificateTemplateInput: $createCertificateTemplateInput\n  ) {\n    _id\n    name\n    fabric_json\n    background_url\n    placeholders\n    created_by\n    createdAt\n    updatedAt\n  }\n}": typeof types.CreateCertificateTemplateDocument,
    "mutation RemoveCertificateTemplate($id: ID!) {\n  removeCertificateTemplate(id: $id)\n}": typeof types.RemoveCertificateTemplateDocument,
    "mutation UpdateCertificateTemplate($updateCertificateTemplateInput: UpdateCertificateTemplateInput!) {\n  updateCertificateTemplate(\n    updateCertificateTemplateInput: $updateCertificateTemplateInput\n  ) {\n    _id\n    name\n    fabric_json\n    background_url\n    placeholders\n    created_by\n    createdAt\n    updatedAt\n  }\n}": typeof types.UpdateCertificateTemplateDocument,
    ...
    "query GetAllCertificateTemplates($paginationInput: PaginationInput!) {\n  getAllCertificateTemplates(paginationInput: $paginationInput) {\n    docs {\n      _id\n      name\n      createdAt\n    }\n    totalDocs\n    limit\n    totalPages\n    page\n    hasNextPage\n    hasPrevPage\n  }\n}": typeof types.GetAllCertificateTemplatesDocument,
    "query GetCertificateTemplateById($id: ID!) {\n  getCertificateTemplateById(id: $id) {\n    _id\n    name\n    fabric_json\n    background_url\n    placeholders\n    created_by\n    createdAt\n    updatedAt\n  }\n}": typeof types.GetCertificateTemplateByIdDocument,
    ...
    "query GetAllEnrollments($paginationInput: PaginationInput, $filters: EnrollmentFiltersInput) {\n  getAllEnrollments(paginationInput: $paginationInput, filters: $filters) {\n    docs {\n      student_name\n      student_email\n      course_name\n      status\n      enrolled_at\n      payment_status\n      method\n      payment_id\n    }\n    totalDocs\n    limit\n    totalPages\n    page\n    hasNextPage\n    hasPrevPage\n  }\n}": typeof types.GetAllEnrollmentsDocument,
...
const documents: Documents = {
    ...
    "mutation CreateCertificateTemplate($createCertificateTemplateInput: CreateCertificateTemplateInput!) {\n  createCertificateTemplate(\n    createCertificateTemplateInput: $createCertificateTemplateInput\n  ) {\n    _id\n    name\n    fabric_json\n    background_url\n    placeholders\n    created_by\n    createdAt\n    updatedAt\n  }\n}": types.CreateCertificateTemplateDocument,
    "mutation RemoveCertificateTemplate($id: ID!) {\n  removeCertificateTemplate(id: $id)\n}": types.RemoveCertificateTemplateDocument,
    "mutation UpdateCertificateTemplate($updateCertificateTemplateInput: UpdateCertificateTemplateInput!) {\n  updateCertificateTemplate(\n    updateCertificateTemplateInput: $updateCertificateTemplateInput\n  ) {\n    _id\n    name\n    fabric_json\n    background_url\n    placeholders\n    created_by\n    createdAt\n    updatedAt\n  }\n}": types.UpdateCertificateTemplateDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation CreateCertificateTemplate($createCertificateTemplateInput: CreateCertificateTemplateInput!) {\n  createCertificateTemplate(\n    createCertificateTemplateInput: $createCertificateTemplateInput\n  ) {\n    _id\n    name\n    fabric_json\n    background_url\n    placeholders\n    created_by\n    createdAt\n    updatedAt\n  }\n}"): (typeof documents)["mutation CreateCertificateTemplate($createCertificateTemplateInput: CreateCertificateTemplateInput!) {\n  createCertificateTemplate(\n    createCertificateTemplateInput: $createCertificateTemplateInput\n  ) {\n    _id\n    name\n    fabric_json\n    background_url\n    placeholders\n    created_by\n    createdAt\n    updatedAt\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation RemoveCertificateTemplate($id: ID!) {\n  removeCertificateTemplate(id: $id)\n}"): (typeof documents)["mutation RemoveCertificateTemplate($id: ID!) {\n  removeCertificateTemplate(id: $id)\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation UpdateCertificateTemplate($updateCertificateTemplateInput: UpdateCertificateTemplateInput!) {\n  updateCertificateTemplate(\n    updateCertificateTemplateInput: $updateCertificateTemplateInput\n  ) {\n    _id\n    name\n    fabric_json\n    background_url\n    placeholders\n    created_by\n    createdAt\n    updatedAt\n  }\n}"): (typeof documents)["mutation UpdateCertificateTemplate($updateCertificateTemplateInput: UpdateCertificateTemplateInput!) {\n  updateCertificateTemplate(\n    updateCertificateTemplateInput: $updateCertificateTemplateInput\n  ) {\n    _id\n    name\n    fabric_json\n    background_url\n    placeholders\n    created_by\n    createdAt\n    updatedAt\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation CreateQuiz($createQuizInput: CreateQuizDto!) {\n  createQuiz(createQuizInput: $createQuizInput) {\n    quiz_id\n  }\n}"): (typeof documents)["mutation CreateQuiz($createQuizInput: CreateQuizDto!) {\n  createQuiz(createQuizInput: $createQuizInput) {\n    quiz_id\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetAllCertificateTemplates($paginationInput: PaginationInput!) {\n  getAllCertificateTemplates(paginationInput: $paginationInput) {\n    docs {\n      _id\n      name\n      createdAt\n    }\n    totalDocs\n    limit\n    totalPages\n    page\n    hasNextPage\n    hasPrevPage\n  }\n}"): (typeof documents)["query GetAllCertificateTemplates($paginationInput: PaginationInput!) {\n  getAllCertificateTemplates(paginationInput: $paginationInput) {\n    docs {\n      _id\n      name\n      createdAt\n    }\n    totalDocs\n    limit\n    totalPages\n    page\n    hasNextPage\n    hasPrevPage\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetCertificateTemplateById($id: ID!) {\n  getCertificateTemplateById(id: $id) {\n    _id\n    name\n    fabric_json\n    background_url\n    placeholders\n    created_by\n    createdAt\n    updatedAt\n  }\n}"): (typeof documents)["query GetCertificateTemplateById($id: ID!) {\n  getCertificateTemplateById(id: $id) {\n    _id\n    name\n    fabric_json\n    background_url\n    placeholders\n    created_by\n    createdAt\n    updatedAt\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetAllEnrollments($paginationInput: PaginationInput, $filters: EnrollmentFiltersInput) {\n  getAllEnrollments(paginationInput: $paginationInput, filters: $filters) {\n    docs {\n      student_name\n      student_email\n      course_name\n      status\n      enrolled_at\n      payment_status\n      method\n      payment_id\n    }\n    totalDocs\n    limit\n    totalPages\n    page\n    hasNextPage\n    hasPrevPage\n  }\n}"): (typeof documents)["query GetAllEnrollments($paginationInput: PaginationInput, $filters: EnrollmentFiltersInput) {\n  getAllEnrollments(paginationInput: $paginationInput, filters: $filters) {\n    docs {\n      student_name\n      student_email\n      course_name\n      status\n      enrolled_at\n      payment_status\n      method\n      payment_id\n    }\n    totalDocs\n    limit\n    totalPages\n    page\n    hasNextPage\n    hasPrevPage\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetQuizById($quizId: String!) {\n  getQuizById(quizId: $quizId) {\n    _id\n    module_id\n    title\n    passing_score\n    created_at\n  }\n}"): (typeof documents)["query GetQuizById($quizId: String!) {\n  getQuizById(quizId: $quizId) {\n    _id\n    module_id\n    title\n    passing_score\n    created_at\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetQuizQuestionsByQuizId($quizId: String!) {\n  getQuizQuestionsByQuizId(quizId: $quizId) {\n    _id\n    question_text\n    type\n    options {\n      option_text\n      is_correct\n    }\n  }\n}"): (typeof documents)["query GetQuizQuestionsByQuizId($quizId: String!) {\n  getQuizQuestionsByQuizId(quizId: $quizId) {\n    _id\n    question_text\n    type\n    options {\n      option_text\n      is_correct\n    }\n  }\n}"];
