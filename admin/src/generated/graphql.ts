...
export type CertificateTemplate = {
  ...
  fabric_json: Scalars['String']['output'];
  name: Scalars['String']['output'];
...
export type CertificateTemplateResponse = {
  __typename: 'CertificateTemplateResponse';
  _id: Scalars['ID']['output'];
  createdAt: Scalars['DateTime']['output'];
  name: Scalars['String']['output'];
};
...
export type Course = {
  ...
  certificate_template_id: Maybe<Scalars['ID']['output']>;
  createdAt: Scalars['DateTime']['output'];
  created_by: Scalars['ID']['output'];
...
export type CreateCertificateTemplateInput = {
  ...
  fabric_json: Scalars['String']['input'];
  name: Scalars['String']['input'];
  placeholders?: Array<Scalars['String']['input']>;
};

export type CreateCourseInput = {
  category_id: Scalars['String']['input'];
  certificate_template_id?: InputMaybe<Scalars['String']['input']>;
...
export type Mutation = {
  ...
  loginOtpVerify: User;
  removeCertificateTemplate: Scalars['Boolean']['output'];
...
export type MutationCreateCertificateTemplateArgs = {
  createCertificateTemplateInput: CreateCertificateTemplateInput;
};
...
export type MutationRemoveCertificateTemplateArgs = {
  id: Scalars['ID']['input'];
};
...
export type MutationUpdateCertificateTemplateArgs = {
  updateCertificateTemplateInput: UpdateCertificateTemplateInput;
};
...
export type PaginatedCertificateTemplate = {
  __typename: 'PaginatedCertificateTemplate';
  docs: Array<CertificateTemplateResponse>;
  hasNextPage: Scalars['Boolean']['output'];
  hasPrevPage: Scalars['Boolean']['output'];
  limit: Scalars['Int']['output'];
  page: Scalars['Int']['output'];
...
export type QueryGetAllCertificateTemplatesArgs = {
  paginationInput: PaginationInput;
};
...
export type UpdateCertificateTemplateInput = {
  background_url?: InputMaybe<Scalars['String']['input']>;
  fabric_json?: InputMaybe<Scalars['String']['input']>;
...
export type CreateCertificateTemplateMutation = { createCertificateTemplate: { __typename: 'CertificateTemplate', _id: string, name: string, fabric_json: string, background_url: string | null, placeholders: Array<string>, created_by: string, createdAt: unknown, updatedAt: unknown } };

export type RemoveCertificateTemplateMutationVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type RemoveCertificateTemplateMutation = { removeCertificateTemplate: boolean };

export type UpdateCertificateTemplateMutationVariables = Exact<{
  updateCertificateTemplateInput: UpdateCertificateTemplateInput;
}>;


export type UpdateCertificateTemplateMutation = { updateCertificateTemplate: { __typename: 'CertificateTemplate', _id: string, name: string, fabric_json: string, background_url: string | null, placeholders: Array<string>, created_by: string, createdAt: unknown, updatedAt: unknown } };
...
export type CreateCourseMutation = { createCourse: { __typename: 'Course', _id: string, title: string, slug: string, description: string | null, thumbnail_url: string, category_id: string, level: string, language: string, price: number, is_published: boolean, created_by: string, certificate_template_id: string | null, createdAt: unknown, updatedAt: unknown } };
...
export type CreateQuizQuestionMutationVariables = Exact<{
  createQuizQuestionInput: CreateQuizQuestionInput;
}>;


export type CreateQuizQuestionMutation = { createQuizQuestion: { __typename: 'QuizQuestion', _id: string, quiz_id: string, question_text: string, type: Quiz_Question_Type, created_at: unknown, options: Array<{ __typename: 'Options', option_text: string, is_correct: boolean }> } };
...
export type RemoveQuizQuestionMutationVariables = Exact<{
  removeQuizQuestionId: Scalars['String']['input'];
}>;


export type RemoveQuizQuestionMutation = { removeQuizQuestion: { __typename: 'QuizQuestion', _id: string } };
...
export type GetAllCertificateTemplatesQueryVariables = Exact<{
  paginationInput: PaginationInput;
}>;


export type GetAllCertificateTemplatesQuery = { getAllCertificateTemplates: { __typename: 'PaginatedCertificateTemplate', totalDocs: number, limit: number, totalPages: number, page: number, hasNextPage: boolean, hasPrevPage: boolean, docs: Array<{ __typename: 'CertificateTemplateResponse', _id: string, name: string, createdAt: unknown }> } };

export type GetCertificateTemplateByIdQueryVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type GetCertificateTemplateByIdQuery = { getCertificateTemplateById: { __typename: 'CertificateTemplate', _id: string, name: string, fabric_json: string, background_url: string | null, placeholders: Array<string>, created_by: string, createdAt: unknown, updatedAt: unknown } };
...
export type GetAllCourseModulesQuery = { getAllCourseModules: { __typename: 'PaginatedCourseModule', totalDocs: number, limit: number, totalPages: number, page: number, hasNextPage: boolean, hasPrevPage: boolean, docs: Array<{ __typename: 'CourseModuleResponse', _id: string, title: string, description: string | null, course_id: string, order: number, createdAt: unknown, lessons: Array<{ __typename: 'LessonResponse', _id: string, title: string, order: number, video_url: string | null, pdf_url: string | null, content: string | null, duration_minutes: number, is_preview: boolean }>, quizzes: Array<{ __typename: 'QuizResponse', _id: string, title: string, passing_score: number, questionCount: number | null, score: number | null, created_at: unknown }> }> } };
...
export type GetCourseByIdQuery = { getCourseById: { __typename: 'CourseWithEnrollment', _id: string, title: string, slug: string, description: string | null, thumbnail_url: string, category_id: string, level: string, language: string, price: number, is_published: boolean, created_by: string, published_at: unknown | null, certificate_template_id: string | null, createdAt: unknown, updatedAt: unknown, is_enrolled: boolean } };
...
export type GetAllEnrollmentsQuery = { getAllEnrollments: { __typename: 'PaginatedEnrollments', totalDocs: number, limit: number, totalPages: number, page: number, hasNextPage: boolean, hasPrevPage: boolean, docs: Array<{ __typename: 'EnrollmentDetails', student_name: string, student_email: string, course_name: string, status: Enrollment_Status, enrolled_at: unknown, payment_status: PaymentStatus | null, method: string | null, payment_id: string | null }> } };
...
export const CreateCertificateTemplateDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateCertificateTemplate"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"createCertificateTemplateInput"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateCertificateTemplateInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createCertificateTemplate"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"createCertificateTemplateInput"},"value":{"kind":"Variable","name":{"kind":"Name","value":"createCertificateTemplateInput"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"fabric_json"}},{"kind":"Field","name":{"kind":"Name","value":"background_url"}},{"kind":"Field","name":{"kind":"Name","value":"placeholders"}},{"kind":"Field","name":{"kind":"Name","value":"created_by"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]} as unknown as DocumentNode<CreateCertificateTemplateMutation, CreateCertificateTemplateMutationVariables>;
export const RemoveCertificateTemplateDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RemoveCertificateTemplate"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"removeCertificateTemplate"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}]}}]} as unknown as DocumentNode<RemoveCertificateTemplateMutation, RemoveCertificateTemplateMutationVariables>;
export const UpdateCertificateTemplateDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateCertificateTemplate"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"updateCertificateTemplateInput"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateCertificateTemplateInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateCertificateTemplate"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"updateCertificateTemplateInput"},"value":{"kind":"Variable","name":{"kind":"Name","value":"updateCertificateTemplateInput"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"fabric_json"}},{"kind":"Field","name":{"kind":"Name","value":"background_url"}},{"kind":"Field","name":{"kind":"Name","value":"placeholders"}},{"kind":"Field","name":{"kind":"Name","value":"created_by"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]} as unknown as DocumentNode<UpdateCertificateTemplateMutation, UpdateCertificateTemplateMutationVariables>;
...
export const CreateQuizQuestionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateQuizQuestion"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"createQuizQuestionInput"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateQuizQuestionInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createQuizQuestion"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"createQuizQuestionInput"},"value":{"kind":"Variable","name":{"kind":"Name","value":"createQuizQuestionInput"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_id"}},{"kind":"Field","name":{"kind":"Name","value":"quiz_id"}},{"kind":"Field","name":{"kind":"Name","value":"question_text"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"options"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"option_text"}},{"kind":"Field","name":{"kind":"Name","value":"is_correct"}}]}},{"kind":"Field","name":{"kind":"Name","value":"created_at"}}]}}]}}]} as unknown as DocumentNode<CreateQuizQuestionMutation, CreateQuizQuestionMutationVariables>;
...
export const RemoveQuizQuestionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RemoveQuizQuestion"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"removeQuizQuestionId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"removeQuizQuestion"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"removeQuizQuestionId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_id"}}]}}]}}]} as unknown as DocumentNode<RemoveQuizQuestionMutation, RemoveQuizQuestionMutationVariables>;
...
export const GetAllCertificateTemplatesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetAllCertificateTemplates"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"paginationInput"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"PaginationInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getAllCertificateTemplates"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"paginationInput"},"value":{"kind":"Variable","name":{"kind":"Name","value":"paginationInput"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"docs"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}},{"kind":"Field","name":{"kind":"Name","value":"totalDocs"}},{"kind":"Field","name":{"kind":"Name","value":"limit"}},{"kind":"Field","name":{"kind":"Name","value":"totalPages"}},{"kind":"Field","name":{"kind":"Name","value":"page"}},{"kind":"Field","name":{"kind":"Name","value":"hasNextPage"}},{"kind":"Field","name":{"kind":"Name","value":"hasPrevPage"}}]}}]}}]} as unknown as DocumentNode<GetAllCertificateTemplatesQuery, GetAllCertificateTemplatesQueryVariables>;
export const GetCertificateTemplateByIdDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetCertificateTemplateById"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getCertificateTemplateById"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"fabric_json"}},{"kind":"Field","name":{"kind":"Name","value":"background_url"}},{"kind":"Field","name":{"kind":"Name","value":"placeholders"}},{"kind":"Field","name":{"kind":"Name","value":"created_by"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]} as unknown as DocumentNode<GetCertificateTemplateByIdQuery, GetCertificateTemplateByIdQueryVariables>;
