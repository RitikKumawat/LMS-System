...
import { CertificateTemplate, PaginatedCertificateTemplate } from '../schemas/certificate-template.schema';
...
export class CertificateTemplateResolver {
    ...
    createCertificateTemplate(
        @Context() ctx,
        @Args('createCertificateTemplateInput') createInput: CreateCertificateTemplateInput,
    ...
    getAllCertificateTemplates(
        ...
        return this.templateService.findAll(paginationInput);
    }
    ...
    updateCertificateTemplate(
        @Args('updateCertificateTemplateInput') updateInput: UpdateCertificateTemplateInput,
    ): Promise<CertificateTemplate> {
