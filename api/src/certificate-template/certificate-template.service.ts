...
export class CertificateTemplateService {
    ...
    async create(createInput: CreateCertificateTemplateInput, admin_id: string): Promise<CertificateTemplate> {
    ...
    async findAll(paginationInput: PaginationInput): Promise<PaginatedResult<CertificateTemplateResponse>> {
    ...
    async update(updateInput: UpdateCertificateTemplateInput): Promise<CertificateTemplate> {
